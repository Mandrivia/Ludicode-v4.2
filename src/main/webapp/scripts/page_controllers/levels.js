$(document).ready(function() {
	...
	function showLevels(data, userNames) {
		for(var i = 0 ; i < data.length ; i++) {
			...
			var template = data[i].idView == 0 ? 'game' : 'python'
			caption.append($('<p><a href="' + template + '.html?level=0&list=' + data[i].id +'" class="btn btn-primary level_preview" role="button">Jouer !</a></p>'));
